...
namespace UnityStandardAssets.Characters.ThirdPersonCharacter
{
    ...
    public class ThirdPersonCharacter : MonoBehaviour
    {
        ...
        [SerializeField]
        private float lookSpeed = 4;//DCURRY add
        [SerializeField]
        ...
        [SerializeField]
        private AudioClip _jumpSound; // the sound played when character leaves the ground.
        [SerializeField]
        private AudioClip _landSound; // the sound played when character touches back on ground.
